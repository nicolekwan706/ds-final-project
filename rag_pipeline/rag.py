...
Original file is located at
    https://colab.research.google.com/drive/1L1BPbL8_lRui0OLWABnfGcm4QC1QKq16
"""
...
def format_context(sources: List[Dict[str, Any]]) -> str:
    """
    Turn retrieved sources into a numbered context block:

    [Source 1] title=... | source=csv/pdf | page=...
    <chunk text>
...
class RAGPipeline:
    """
    End-to-end RAG:
    - Retrieve top-k chunks with Retriever
    - Build a grounded prompt
    - Generate an answer with Phi-3-mini-4k-instruct
    """
    ...
    def __init__(self, model_name: str = LLM_MODEL_NAME, device: Optional[str] = None) -> None:
        ...
        #load model; on CPU use float32, on GPU use float16
    ...
    def build_prompt(self, question: str, sources: List[Dict[str, Any]]) -> str:
        """
        Build a single text prompt, similar to the lab style:
        ...
        ANSWER: (model will complete from here)
        """
...
ANSWER (remember to cite sources like [Source 1], [Source 2]):"""
    ...
    def answer(self, question: str, k: int = 5, max_new_tokens: int = 96) -> Dict[str, Any]:
        ...
        #slice off the prompt tokens: keep only newly generated part
...
def main():
    ...
    #question 1: PDF-based reasoning

    question1 = "What factors influence box office performance according to the context?"
    result1 = rag.answer(question1, k=5, max_new_tokens=96)
    ...
    #question 2: ETL CSV dataset question

    question2 = "Which movie in the dataset has the highest IMDb rating?"
    result2 = rag.answer(question2, k=5, max_new_tokens=96)
